...
export abstract class BaseMapper<E extends IEntity> implements IMapper<E> {
  ...
  persistent2Dto(persistentEntity: E): any | Promise<any> {
    throw new Error('Implements me in Subclass');
  }

  dtoInput2Persistent<DTO extends BaseInput>(dto: DTO): E | Promise<E> {
    throw new Error('Implements me in Subclass');
  }


  dtoResponse2Persistent<DTO extends BaseResponse>(dto: DTO): E | Promise<E> {
    throw new Error('Implements me in Subclass');
  }
