...
import { AdditionalInfoFeature } from './entities/schemas/additional-info.schema';
import { AdditionalInfoResolver } from './graphql/resolver/additional-info.resolver';
import { MultiLevelInfoResolver } from './graphql/resolver/multi-level-info.resolver';
...
@Module({
  ...
  providers: [
    ...TenantUtils.buildTenantEntityProvider([UserFeature, ProfileFeature, AdditionalInfoFeature]),
    UserMapper,
    UserRepository,
    UserService,
    UserResolver,
