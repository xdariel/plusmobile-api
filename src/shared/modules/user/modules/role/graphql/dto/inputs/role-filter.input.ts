...
@ObjectType()
export class RoleFilter implements IEntityFilter<RoleEntity> {
  @FilterableField(() => String, { nullable: true }) id?: string;
  @FilterableField(() => String, { nullable: true }) name?: string;
  @FilterableField(() => Boolean, { nullable: true }) onlyAdmin?: boolean;
...
export const RoleFilterInput = FilterType(RoleFilter);